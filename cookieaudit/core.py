"""COOKIEAUDIT core — Audit Set-Cookie flags (Secure/HttpOnly/SameSite) from a response dump."""
...
RULES = [
    ("COO-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("COO-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("COO-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
