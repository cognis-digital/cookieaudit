"""COOKIEAUDIT command-line interface."""
from __future__ import annotations
import argparse, sys
from cookieaudit.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="cookieaudit", description="COOKIEAUDIT — Cognis Neural Suite")
