#!/usr/bin/env sh
# Universal installer for cookieaudit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/cookieaudit.git"
echo "Installing cookieaudit ..."
...
echo "Done. Run: cookieaudit --help"
